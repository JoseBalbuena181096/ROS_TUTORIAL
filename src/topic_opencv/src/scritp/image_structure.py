...
print(img)
print("In python , an image is stored in a numpy array. Numpy is library used for scientific computing of multi-dimencional arrays and matrices")
print("We can determine several features of the image using numpy array properties")
print("type of the an image type(img):%s"%type(img))
print("length of image (number of pixel in the vertical direction) len(img): %d"%len(img))
