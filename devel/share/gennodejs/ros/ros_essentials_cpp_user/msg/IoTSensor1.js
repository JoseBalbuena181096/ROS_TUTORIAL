...
// (in-package ros_essentials_cpp_user.msg)
...
class IoTSensor1 {
  ...
  static datatype() {
    ...
    return 'ros_essentials_cpp_user/IoTSensor1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IoTSensor1(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
